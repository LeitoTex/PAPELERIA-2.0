Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        prod = Val(TXT_CODIGO.Text)
            If Consulta_Codigo(prod) = True Then
                TXT_CODIGO.Text = CodigoP
                TXT_DESCRIPCION.Text = NombreP
                TXT_CANTIDAD.Text = CantidadP
                TXT_PRECIO.Text = PrecioP
            End If
