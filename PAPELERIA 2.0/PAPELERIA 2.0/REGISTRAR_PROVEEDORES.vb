...
Public Class REGISTRAR_PROVEEDORES
    ...
    Dim obj_clientes As New cls_proveedores
    Dim n As Integer
    Dim ini As Integer
    Dim f As Integer
    Dim id As Integer
    ...
    Private Sub NUEVO_USUARIO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ini = 0
        ActualizarTabla(Me.DGV1, "proveedores", "", "nombre") 'tabla ususarios ordenado por apellido
        ' Label6.Text = "1"
        ' Label9.Text = n
        Pinta_fila(ini)
    ...
    Private Sub BTN_MODIFICAR_Click(sender As Object, e As EventArgs) Handles BTN_MODIFICAR.Click
        Try
            ...
            If i = MsgBoxResult.Yes Then
                If ValidarDatos() Then
                    If obj_clientes.Modifica_proveedores(TXT_NOMBRE.Text,
                                                     TXT_domicilio.Text,
                                                     txt_RUT.Text,
                                                     id) = True Then
